...
def nlq_unsupported_message() -> str:
    return "Я можу відповідати лише на питання про твої витрати, доходи, перекази та персональну фінансову аналітику."


def nlq_llm_scope_guard_message() -> str:
    return (
        "Я можу допомагати лише з персональною фінансовою аналітикою: "
        "витрати, доходи, перекази, категорії, мерчанти, періоди та висновки по твоїх фінансах."
    )
